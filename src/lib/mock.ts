...
const ALEX_LINES = [
  ...
  'honestly the whole day would have been better if you had been there with me',
  'i walked past that little bakery again and thought of you immediately',
  'okay so the meeting ran over and now i am definitely going to be late',
  'remind me to tell you about the thing that happened on the bus this morning',
  'i think we should just book the whole weekend and not tell anyone about it',
  'the soup recipe worked but only because i ignored half the instructions',
  'you are going to think this is ridiculous but i already miss talking to you',
  'i found the photo from that night and i cannot stop laughing at your face',
  'if we leave before seven we can probably beat the traffic on the motorway',
  'my mother asked about you again and i did not know what to tell her',
  'i had the strangest dream about us being lost in a supermarket somewhere',
  'genuinely the best part of my day is when your name shows up on my phone',
  'we should do that thing you mentioned before the weather turns properly cold',
  'love that',
...
const JAMIE_LINES = [
  ...
  'i have been thinking about what you said and i think you were probably right',
  'the train was delayed for an hour and i read the entire book you gave me',
  'nobody warned me that adult life is mostly just deciding what to eat again',
  'i cannot believe you did that without telling me first but i love you anyway',
  'please tell me you remembered to take the thing out of the freezer this time',
  'this is officially the funniest thing that has happened to me all week honestly',
  'i keep starting this message and deleting it so i am just going to send it',
  'we are absolutely going back to that restaurant the moment they reopen it',
  'you have no idea how much i needed to hear that from you this evening',
  'the cat has decided that my laptop keyboard is the only acceptable place to sleep',
  'i told everyone at work about your soup and now they all want the recipe',
  'if i fall asleep before you reply it is because today completely destroyed me',
  'something about the light this afternoon made me want to call you immediately',
